          ...
          <ul class="nav">
            <li class="dropdown"> <a href="index.html" class="dropdown-toggle" data-toggle="dropdown">Home </a>
              <ul class="dropdown-menu multi-level">
                ...
                <li><a href="index-1.html">Index Version 2</a></li>
                <li><a href="index-2.html">Index Version 3</a></li>
                <li><a href="index-flex-slider.html">Index Flex Slider </a></li>
              </ul>
            </li>
            ...
            <li class="dropdown"> <a href="index.html" class="dropdown-toggle" data-toggle="dropdown">Pages </a>
              <ul class="dropdown-menu multi-level">
                ...
                <li class="dropdown-submenu"> <a href="index.html" class="dropdown-toggle" data-toggle="dropdown">Gallery</a>
                  <ul class="dropdown-menu animated-2s fadeInRight">
                    <li><a href="gallery.html">Gallery </a></li>
                    <li><a href="gallery-2-col.html">Gallery 2 Col</a></li>
                    <li><a href="gallery-4-col.html">Gallery 4 Col</a></li>
                    <li><a href="gallery-5-col.html">Gallery 5 Col</a></li>
                  </ul>
                </li>
                <li class="dropdown-submenu"> <a href="index.html" class="dropdown-toggle" data-toggle="dropdown">Gallery Style 1</a>
                  <ul class="dropdown-menu animated-2s fadeInRight">
                    <li><a href="gallery-1.html">Gallery Style 1</a></li>
                    <li><a href="gallery-1-2-col.html">Gallery Style 1 2 Col</a></li>
                    <li><a href="gallery-1-4-col.html">Gallery Style 1 4 Col</a></li>
                    <li><a href="gallery-1-5-col.html">Gallery Style 1 5 Col</a></li>
                  </ul>
                </li>
  ...
  <section class="sub-bnr" data-stellar-background-ratio="0.5">
    <div class="position-center-center">
      <div class="container">
        ...
        <h1>PROFESSIONAL TEAM OF DOCTORS</h1>
    ...
    <section class="young-doc-team p-t-b-150 padding-bottom-0">
      <div class="container"> 
        ...
        <div class="heading-block">
          <h4>We are Team of Young Professionals Passionate in our Work</h4>
          <hr>
            ...
            <div class="doctor-in">
              ...
              <div class="personal-info">
                ...
                <ul class="row">
                  ...
                  <li class="col-sm-8">janebutler@medical.com</li>
                </ul>
                <ul class="row">
        ...
        <div class="team-part">
          <div class="row"> 
            ...
            <div class="col-sm-4">
              <article> 
                <!-- Team Img -->
                <div class="team-img"> <img class="img-responsive" src="images/se-doc-img-1.jpg" alt=""> 
            ...
            <div class="col-sm-4">
              <article> 
                <!-- Team Img -->
                <div class="team-img"> <img class="img-responsive" src="images/se-doc-img-2.jpg" alt=""> 
            ...
            <div class="col-sm-4">
              <article> 
                <!-- Team Img -->
                <div class="team-img"> <img class="img-responsive" src="images/se-doc-img-3.jpg" alt=""> 
            ...
            <div class="col-sm-4">
              <article> 
                <!-- Team Img -->
                <div class="team-img"> <img class="img-responsive" src="images/se-doc-img-4.jpg" alt=""> 
            ...
            <div class="col-sm-4">
              <article> 
                <!-- Team Img -->
                <div class="team-img"> <img class="img-responsive" src="images/se-doc-img-5.jpg" alt=""> 
            ...
            <div class="col-sm-4">
              <article> 
                <!-- Team Img -->
                <div class="team-img"> <img class="img-responsive" src="images/se-doc-img-6.jpg" alt=""> 
        ...
        <div class="col-md-3">
          <div class="latest-tweet">
            ...
            <ul>
              ...
              <!--Tweet 1 -->
              <li>
                <p><span>@medical</span> Sweets and Bakers 
                  WordPress Theme' on @EnvatoMarket by themefore<a href="#."> http://t.co/we8Kf0</a></p>
                <span class="date"> - Thursday March 9, 2017</span> </li>
              
              <!--Tweet 2 -->
              <li>
                <p><span>@medical</span> In hendrerit in molestie consequat in <a href="#."> http://t.co/we8Kf0</a></p>
                <span class="date"> - Thursday March 9, 2017</span> </li>
              
              <!--Tweet 3 -->
              <li>
                <p><span>@medical</span> Duis autem vel eum iriure <span>@medikal</span> dolor in hendrerit in molestie consequat <a href="#."> http://t.co/we8Kf0</a></p>
                <span class="date"> - Thursday March 9, 2017</span> </li>
            </ul>
          </div>
        </div>
